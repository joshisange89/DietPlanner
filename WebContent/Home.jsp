		...
		<div class="contaier col-md-4">
			<div class="leftside">
				    ...
				    <input type="hidden" id="calculateAction" name="calculateAction" value="bmi" />
						<button class="button button:active" id="viewBmi" onclick="viewBMI()">View My BMI</button>
					    <p id="bmi" name="bmi" align="center"></p>				
						<br />
						<br />
					</form>
					<form role="form" action="HomeServlet" method="post">
...
function viewBMI() {
	...
	bmi.innerHTML = <%= (userProfile.getWeight() * 703) / (height * height) %>;
}
</script>
</body>
</html>